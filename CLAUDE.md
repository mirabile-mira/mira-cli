...
This project is indexed by GitNexus as **mirabile** (128 symbols, 190 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/mirabile/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/mirabile/context` | Codebase overview, check index freshness |
| `gitnexus://repo/mirabile/clusters` | All functional areas |
| `gitnexus://repo/mirabile/processes` | All execution flows |
| `gitnexus://repo/mirabile/process/{name}` | Step-by-step execution trace |
